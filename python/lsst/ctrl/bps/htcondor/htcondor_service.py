...
import htcondor
from lsst.ctrl.bps import BaseWmsService
...
from .report import _report_from_id, _report_from_path, _summary_report
from .restart import restart
from .utils import WmsIdType, _locate_schedds, _wms_id_to_cluster, _wms_id_type
from .workflow import HTCondorWorkflow
...
class HTCondorService(BaseWmsService):
    ...
    def restart(self, wms_workflow_id):
        ...
        """
        return restart(wms_workflow_id)
